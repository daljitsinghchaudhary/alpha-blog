...
class Config {
    ...
    get cacheDir() { return this.scopedEnvVar('CACHE_DIR') || this.macosCacheDir || this.dir('cache'); }
    get configDir() { return this.scopedEnvVar('CONFIG_DIR') || this.dir('config'); }
    get dataDir() { return this.scopedEnvVar('DATA_DIR') || this.dir('data'); }
    ...
    get pjson() {
        ...
        return Object.assign({ 'cli-engine': Object.assign({}, this.opts.pjson && this.opts.pjson['cli-engine'] || {}), dependencies: {}, name: 'cli-engine', version: '0.0.0' }, (this.opts.pjson || {}));
    }
    get userAgent() {
